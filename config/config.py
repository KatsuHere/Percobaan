...
PRIVACY_LINK = getenv(
    "PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-NyxMusic-08-30"
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TheTeamVivek/NyxMusic",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/TheTeamVivek/NyxMusic")
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @NyxStringBot
STRING_SESSIONS = list(map(str.strip, getenv("STRING_SESSIONS", "").split(",")))
